...
#  Объявляем классы наследники Warrior, Mage, Healer
...
#  Проверили ка кработает
#  Добавили объект класса Warrior
#warrior = Warrior('Кодослав')
#  Вызвали объект класса
#print(warrior)
#  Вызвали метод объекта класса
